...
public class CreateLineReactorCommandValidator : AbstractValidator<CreateLineReactorCommand>
{
    private readonly IApplicationDbContext _context;

    public CreateLineReactorCommandValidator(IApplicationDbContext context)
    {
        _context = context;
    ...
    public async Task<bool> BeInLineSubstation(CreateLineReactorCommand cmd, CancellationToken cancellationToken)
    {
