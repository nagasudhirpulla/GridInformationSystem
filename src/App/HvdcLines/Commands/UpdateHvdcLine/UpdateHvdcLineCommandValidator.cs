...
public class UpdateHvdcLineCommandValidator : AbstractValidator<UpdateHvdcLineCommand>
{
    private readonly IApplicationDbContext _context;

    public UpdateHvdcLineCommandValidator(IApplicationDbContext context)
    {
        _context = context;
    ...
    public async Task<bool> BeUniqueLinesBetweenSubstations(UpdateHvdcLineCommand cmd, CancellationToken cancellationToken)
    {
    ...
    public async Task<bool> BeSameVoltageLevelBuses(UpdateHvdcLineCommand cmd, CancellationToken cancellationToken)
    {
