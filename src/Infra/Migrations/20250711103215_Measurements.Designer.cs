...
[Migration("20250711103215_Measurements")]
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("Core.Entities.Common.GridEntity", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                ...
                b.ToTable("GridEntities", t =>
                    {
                        t.Property("OwnerNamesCache")
                            .HasColumnName("Substation_OwnerNamesCache");

                        t.Property("RegionCache")
                            .HasColumnName("Substation_RegionCache");
                    });
                ...
                b.ToTable("GridEntities", t =>
                    {
                        ...
                        t.Property("MvaCapacity")
                            .HasColumnName("GeneratingStation_MvaCapacity");
                    });
        ...
        modelBuilder.Entity("Core.Entities.Data.Measurement", b =>
            {
                ...
                b.HasOne("Core.Entities.Common.GridEntity", "Entity")
                    .WithMany()
